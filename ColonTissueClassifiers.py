...
#    print("Best score = {}".format(-res_gp.fun))
#    
#    logistic_regression_f_test_index.append(f_test)
...
#outputPickleFileHandle = open("temp.pkl", "wb")
#pickle.dump(temp_data, outputPickleFileHandle)
#outputPickleFileHandle.close()
#
#inputFileHandle = open("temp.pkl", "rb")
#temp_data2 = pickle.load(inputFileHandle)
